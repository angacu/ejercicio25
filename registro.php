...
<html>
  ...
  <body>
    <form class="" action="registro.php" method="post">
        ...
        Reescribe contraseña:<input type="password" name="pass2" value=""><br><br>
      ...
      if ($tabla==null) {
        ...
        if ($_POST['pass']==$_POST['pass2']) {
          ...
          if ($resultado==null) {
            ...
            echo "<a href='registro.php'>Error, revisa tu contraseñaas.</a>";
        }
      }
    }
     ?>
